...
class FamilyUploadImageScreen extends StatefulWidget {
  const FamilyUploadImageScreen({super.key});

  @override
  State<FamilyUploadImageScreen> createState() =>
      _FamilyUploadImageScreenState();
}

class _FamilyUploadImageScreenState extends State<FamilyUploadImageScreen> {
  File? _pickedImage;
