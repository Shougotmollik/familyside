...
class SpOtpVerificationScreen extends ConsumerStatefulWidget {
  final String? email;
  const SpOtpVerificationScreen({super.key, this.email});

  @override
  ConsumerState<SpOtpVerificationScreen> createState() =>
      _SpOtpVerificationScreenState();
}

class _SpOtpVerificationScreenState
    extends ConsumerState<SpOtpVerificationScreen> {
  ...
  Future<void> _onVerify() async {
    ...
    if (success && mounted) {
      context.push(
        RouterPath.spResetPasswordScreen,
