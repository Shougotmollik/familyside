...
class FamilyUploadImageScreen extends ConsumerStatefulWidget {
  const FamilyUploadImageScreen({super.key});

  @override
  ConsumerState<FamilyUploadImageScreen> createState() =>
      _FamilyUploadImageScreenState();
}

class _FamilyUploadImageScreenState extends ConsumerState<FamilyUploadImageScreen> {
  File? _pickedImage;
